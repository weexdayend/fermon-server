...
const create = async (req, res, next) => {
    try { 
        ...
        const result = await petugasService.create(request);
        res.status(200).json({
            data: result
        })
    } catch (e) {
...
const get = async (req, res, next) => {
    try {
        ...
        const result = await petugasService.get(id);
        res.status(200).json({
            data: result
        })
    } catch (e) {
...
const update = async (req, res, next) => {
    try {
        ...
        const request = req.body;
        const result = await petugasService.update(request);
        res.status(200).json({
            data: result
        })
    } catch (e) {
...
const remove = async (req, res, next) => {
    try {
        ...
        await petugasService.remove(id);
        res.status(200).json({
